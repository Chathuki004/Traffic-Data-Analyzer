...
# Asks the user if they want to load another file and checks if they answer "Y" or "N".
...
def process_csv_data(file_name, date):
    '''Reads the data from CSV files and processes it based on the user-specified date'''
    ...
    #Saves the processed outcomes to a text file and overwrites if the program loops.
